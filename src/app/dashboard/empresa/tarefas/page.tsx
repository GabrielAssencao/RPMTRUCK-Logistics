    ...
    <div className="mx-auto max-w-[1500px] space-y-6 font-mono">
      ...
      {mostrarFormulario && (
        <form onSubmit={criarTarefa} className="grid gap-4 border p-5 md:grid-cols-2" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--background-secondary)' }}>
          ...
          <div className="md:col-span-2"><Campo label="Descrição"><textarea rows={3} value={form.descricao} onChange={e => setForm({ ...form, descricao: e.target.value })} className="w-full resize-y border bg-transparent p-3 text-sm outline-none" style={{ borderColor: 'var(--border)' }} /></Campo></div>
